...
export class AllInOneTableComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @Input()
  columns: ListColumn[] = [
    { name: 'Seleção', property: 'checkbox', visible: false },
    { name: 'Image', property: 'image', visible: true },
    { name: 'Name', property: 'name', visible: true, isModelProperty: true },
    { name: 'Estado', property: 'street', visible: true, isModelProperty: true },
    { name: 'CEP', property: 'zipcode', visible: true, isModelProperty: true },
    { name: 'Ceidade', property: 'city', visible: true, isModelProperty: true },
    { name: 'Telefone', property: 'phoneNumber', visible: true, isModelProperty: true },
